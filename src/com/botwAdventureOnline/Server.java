...
public class Server {
    ...
    public static void acceptClients(ServerSocket server) throws IOException {
    ...
    public void acceptsClients(ServerSocket server) {
        Runnable acceptClient = () -> {
            while (true) {
                Socket client = null;
                try {
                    ...
                    Thread t = new ClientThread(client, dis, dos);
