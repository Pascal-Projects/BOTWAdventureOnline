...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (!"".equals(playerName) && mapHeight > 0 && mapWidth > 0) {
            player = new Player(playerName, 200, 100, 1);
    ...
    public static void stats() {
        ...
        System.out.println("X: " + map.getPlayerX());
        System.out.println("Y: " + map.getPlayerY() + "\n");
