...
public class Main {
     ...
     * System.out.println(counter + ". Health Potion (Health points: " +
     * potion.getHealthPoints() + ", Value: " + potion.getValue() + " Rupees)");
     * } else if (potion.getName().equals("Experience Potion")) {
     * System.out.println(counter + ". Experience Potion (Experience points: " +
     * potion.getExperiencePoints() + ", Value: " + potion.getValue() + " Rupees)");
     * }
     * counter++;
     * }
     ...
     * inventory.getPotions().get(choice).getWeightInt());
     ...
     * System.out.println(counter + ". " + sword.getName() + " (Damage: " +
     * sword.getDamage() + ", Value: " + sword.getValue() + " Rupees)");
     * counter++;
     * }
     * choice = scanner.nextInt() - 1;
     ...
     * inventory.setWeight(inventory.getWeight() -
     * inventory.getSwords().get(choice).getWeightInt());
     * inventory.removeSword(inventory.getSwords().get(choice));
     * } else {
     * System.out.
     * println("You try to drop the sword you have equipped! Do you want to drop it anyway?\n >>>"
     * );
     ...
     * System.out.println(counter + ". " + potion.getName() + "(Health Points: " +
     ...
     * inventory.removePotion(potionList.get(choice));
     * } else {
     * System.out.println("You would waste " + (player.getHp() +
     * potionList.get(choice).getExperiencePointsInt() - player.getMaxHp()) +
     * " health points");
     ...
     * System.out.println(counter + ". " + item.getName() + " (Experience points: "
     * + item.getExperiencePoints()
     * + ", Value: " + item.getValue() + " Rupees)");
     * } else if (item.getName().equals("Health Potion")) {
     * System.out.println(counter + ". " + item.getName() + " (Health points: " +
     * item.getHealthPoints() + ", Value: "
     * + item.getValue() + " Rupees)");
     * } else {
     * System.out.println(counter + ". " + item.getName() + " (Damage: " +
     * item.getDamage() + ", Value: "
     * + item.getValue() + " Rupees)");
     * }
     * counter++;
     * }
     ...
     * if (inventory.getWeight() + map.getLoot(player).get(choice -
     * 1).getWeightInt() <= inventory.getMaxWeight()) {
     ...
     * inventory.setWeight(inventory.getWeight() + map.getLoot(player).get(choice -
     * 1).getWeightInt());
     ...
     * } else {
     * System.out.
     * println("You are not yet strong enough to pick up the Master Sword!");
     * }
     * } else {
     * inventory.addSword(map.getLoot(player).get(choice - 1));
     * inventory.setWeight(inventory.getWeight() + map.getLoot(player).get(choice -
     ...
     * player.hit(damage);
     * System.out.println("Attack from " + enemies.get(i).getName() + "! You lost "
     * + damage + " health points!");
     * }
     * }
     * }
     * if (player.getHp() != player.getMaxHp()) {
     * System.out.println("You won the fight but you only have " + player.getHp() +
     * " health points left!");
     * } else {
     ...
     * for (Item potion : inventory.getPotions()) {
     * if (potion.getName().equals("Health Potion")) {
     * System.out.println("Health Potion (Health points: " +
     * potion.getHealthPoints() + ", Value: " + potion.getValue() + " Rupees)");
     * } else if (potion.getName().equals("Experience Potion")) {
     * System.out.println("Experience Potion (Experience points: " +
     * potion.getExperiencePoints() + ", Value: " + potion.getValue() + " Rupees)");
     * }
     * }
     * for (Item sword : inventory.getSwords()) {
     * System.out.println(sword.getName() + " (Damage: " + sword.getDamage() +
     * ", Value: " + sword.getValue() + " Rupees)");
     * }
     * System.out.println('\n' +
     ...
     * System.out.
     * println("Do you want to increase the maximum weight of your inventory for one korokseed?\n >>>"
     * );
     * input = scanner.next();
     ...
     * } else {
     * System.out.
     * println("You don't have enough korokseeds to increase the maximum weight of your inventory."
     * );
     * }
     * } else {
     * if (inventory.getKorokSeeds() >= (Hestu.getHestuUsed() - 1)) {
     * System.out.
     * println("Do you want to increase the maximum weight of your inventory for " +
     * (Hestu.getHestuUsed() - 1) + " korokseeds?\n >>>");
     * input = scanner.next();
     * if ("yes".equalsIgnoreCase(input)) {
     * inventory.setMaxWeight(inventory.getMaxWeight() + 1);
     * inventory.setKorokSeeds(inventory.getKorokSeeds() - (Hestu.getHestuUsed() -
     * 1));
     * Hestu.setHestuUsed(Hestu.getHestuUsed() + 1);
     * }
     * } else {
     * System.out.
     * println("You don't have enough korokseeds to increase the maximum weight of your inventory. Find koroks to get korokseeds"
     * );
     * }
     * }
     * }
     * } else {
     * System.out.
     * println("Hestu is not located on this field. Search for him on another field"
     * );
     * }
     * }
     * 
     ...
     * }
     * 
     * public static void addCommand(String pCommand, String pMethodName) throws
     * Exception {
